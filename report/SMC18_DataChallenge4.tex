...
the bulk of processing, I use awk. 
...
Swift parallel scripting tool is used to parallelize the computations. Swift
uses an MPI based communication and load-balancing model to parallelize over
