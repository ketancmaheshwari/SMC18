...
app (file out) myawk (file awkprog, file infile, string topic1, string topic2){
    "/usr/bin/awk" "-v" "topic1="topic1 "topic2="topic2 "-f" awkprog infile @stdout=out
}
...
foreach v, i in aminer{
    outfiles[i] = myawk(input("/home/km0/SMC18/src/prob4_p1.awk"), v, "evolution", "human");
}
